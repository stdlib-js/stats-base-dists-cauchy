...
```javascript
import cauchy from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-cauchy@v0.3.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dists-cauchy/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/stats-base-dists-cauchy/actions/workflows/test.yml?query=branch:v0.3.1
